...
public class MessageFotoGrupoHolder extends RecyclerView.ViewHolder implements LinkUtils.OnClickListener, ItemTouchHelperViewHolder, View.OnLongClickListener, View.OnClickListener {
    ...
    public MessageFotoGrupoHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(MessageUi2 messageUic, int personaId, MessageAdapter.Listener listener){
        ...
        if(messageUic.getEmisorId()== personaId)
        {
            ...
            Log.d(MessageFotoGrupoHolder.class.getSimpleName(),"estado: " + messageUic.getEstado().toString());
            ...
            if(messageUic.getEstado()!= MessageUi2.ESTADO.ELIMINADO){
                ...
                if(TextUtils.isEmpty(messageUi2.getImagenFcm())){
                   Glide.with(itemView.getContext())
                    ...
                    Log.d(MessageFotoGrupoHolder.class.getSimpleName(), "Imagen: "+ messageUi2.getImagen() );
                }else {
                    ...
                    Log.d(MessageFotoGrupoHolder.class.getSimpleName(), "ImagenFcm: "+ messageUi2.getImagenFcm() );
                }
