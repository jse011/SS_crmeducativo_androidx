...
import com.whatsappcamera.WhatsappCameraActivity;
...
public class MediaDetailPickerFragment extends BaseFragment implements FileAdapterListener{
            ...
            else
            {
                ...
                photoGridAdapter.setCameraListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(getContext(), WhatsappCameraActivity.class);
                        getActivity().startActivityForResult(intent, WhatsappCameraActivity.REQUEST_TAKE_PHOTO);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode)
        {
            ...
            case WhatsappCameraActivity.REQUEST_TAKE_PHOTO:
                if(resultCode== Activity.RESULT_OK)
                {
                    Bundle bundle = data.getExtras();
                    if(bundle==null)break;

                    String imagePath = bundle.getString(WhatsappCameraActivity.CAPTURED_PHOTO_PATH_KEY);
                    if(imagePath!=null && PickerManager.getInstance().getMaxCount()==1)
                    {
                        PickerManager.getInstance().add(imagePath, FilePickerConst.FILE_TYPE_MEDIA);
                        mListener.onItemSelected();
