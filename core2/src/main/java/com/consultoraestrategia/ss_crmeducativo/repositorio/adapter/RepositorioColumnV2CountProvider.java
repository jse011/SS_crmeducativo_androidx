...
public class RepositorioColumnV2CountProvider implements AutoColumnGridLayoutManager.ColumnCountProvider {
    @NonNull
    private final Context context;

    public RepositorioColumnV2CountProvider(@NonNull Context context) {
