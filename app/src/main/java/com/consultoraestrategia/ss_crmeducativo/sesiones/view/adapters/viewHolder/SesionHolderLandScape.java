...
public class SesionHolderLandScape extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public SesionHolderLandScape(View v) {
        super(v);
    ...
    public void bind(AdapterUnidades.UnidadesListener listener, int vint_backgroudColor, SesionAprendizajeUi sesionAprendizaje, Calendar calendar, int programaEducativoId){
        ...
        txt_numsesion.setText(String.valueOf(sesionAprendizaje.getNroSesion()));
        txt_titulosesion.setText(sesionAprendizaje.getTitulo());
        txttiempo.setText(String.valueOf(sesionAprendizaje.getHoras()));
