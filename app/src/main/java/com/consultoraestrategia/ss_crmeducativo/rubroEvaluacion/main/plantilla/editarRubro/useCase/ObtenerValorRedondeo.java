...
public class ObtenerValorRedondeo extends UseCase<ObtenerValorRedondeo.RequestValues, ObtenerValorRedondeo.ResponseValue>{

    private EditarRubrosRepository repository;

    public ObtenerValorRedondeo(EditarRubrosRepository repository) {
    ...
    protected void executeUseCase(RequestValues requestValues) {
        repository.obtenerValorRedondeo(requestValues.getRubroProcesoUi(), new EditarRubrosDataSource.CallBackRegistro<String, String>() {
            @Override
