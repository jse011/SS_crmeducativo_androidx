...
import com.consultoraestrategia.ss_crmeducativo.rubroEvaluacion.mostrarCamposAccion.adapter.holder.CamposAccionHolder;
...
public class CamposAccionAdapter extends RecyclerView.Adapter<CamposAccionHolder> {
    ...
    public CamposAccionHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_campos_accion, parent, false);
