...
public class ObtenerDatosNivelLogro extends UseCase<ObtenerDatosNivelLogro.RequestValues, ObtenerDatosNivelLogro.ResponseValue> {
    ...
    public ObtenerDatosNivelLogro(EditarRubrosRepository repository) {
        this.repository = repository;
    }

    @Override
    protected void executeUseCase(RequestValues requestValues) {
        repository.obtenerRegistroTipoNota(requestValues.getRubroProcesoUi(), new EditarRubrosDataSource.CallBackRegistro<String, String>() {
            @Override
