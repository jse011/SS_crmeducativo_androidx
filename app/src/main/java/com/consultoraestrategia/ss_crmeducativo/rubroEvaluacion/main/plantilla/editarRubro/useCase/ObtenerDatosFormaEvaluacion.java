...
public class ObtenerDatosFormaEvaluacion extends UseCase<ObtenerDatosFormaEvaluacion.RequestValues, ObtenerDatosFormaEvaluacion.ResponseValue> {
    ...
    public ObtenerDatosFormaEvaluacion(EditarRubrosRepository repository) {
        this.repository = repository;
    }

    @Override
    protected void executeUseCase(RequestValues requestValues) {
        repository.obtenerRegistroTipoForma(requestValues.getRubroProcesoUi(), new EditarRubrosDataSource.CallBackRegistro<String, String>() {
            @Override
