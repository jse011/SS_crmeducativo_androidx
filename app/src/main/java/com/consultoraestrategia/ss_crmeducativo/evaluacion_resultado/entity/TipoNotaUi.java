...
public class TipoNotaUi {
    ...
    public TipoNotaUi(String id, String nombre, String valorDefecto, int valorMinimo, int valorMaximo, double longitudPaso, int tipoId, List<ValorTipoNotaUi> valorTipoNotaList) {
        this.id = id;
        this.nombre = nombre;
