package com.consultoraestrategia.ss_crmeducativo.graficos;
...
import com.consultoraestrategia.ss_crmeducativo.utils.ProgresBarAnim;
...
public class DesempenoActivity extends AppCompatActivity {

    private static final String TAG = DesempenoActivity.class.getSimpleName();
    @BindView(R.id.chart)
    RadarChart mChart;
    ...
    @BindView(R.id.horizontal_progress_barTr)
    ProgressBar progressBarCapacidad1;
    @BindView(R.id.horizontal_progress_barTr2)
    ProgressBar progressBarCapacidad2;
    @BindView(R.id.horizontal_progress_barTr3)
    ProgressBar progressBarCapacidad3;
    @BindView(R.id.horizontal_progress_barTr4)
    ProgressBar progressBarCapacidad4;
    @BindView(R.id.horizontal_progress_barTr5)
    ProgressBar progressBarCapacidad5;
    ...
    private void initProgressBarcapacidad() {
        ...
        progressBarCapacidad5.setProgressDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.progress_bar_red));
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        ProgresBarAnim anim = new ProgresBarAnim(progressBarPrimer, 0, 40);
        ...
        if(!((Activity) this).isFinishing())
        {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    textViewCountProgressTwo.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.color_green));
                }
            });
        }
        ...
        if(!((Activity) this).isFinishing())
        {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    textViewCountProgres.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.color_yellow));
                }
            });
        }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desempeno);
    ...
    private void initGraphic() {
        ...
        xAxis.setValueFormatter(new IAxisValueFormatter() {
            ...
            private String[] mActivities = new String[]{"1.Traduce", "2.Modela", "3.Estrategia", "4.Argumenta", "5.Comunica"};
