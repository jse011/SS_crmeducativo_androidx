...
public class CursoColumnCountProvider implements AutoColumnGridLayoutManager.ColumnCountProvider {
    @NonNull
    private final Context context;

    public CursoColumnCountProvider(@NonNull Context context) {
