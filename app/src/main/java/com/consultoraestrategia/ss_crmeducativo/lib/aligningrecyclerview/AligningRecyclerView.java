 ...
 */
package com.consultoraestrategia.ss_crmeducativo.lib.aligningrecyclerview;
...
public class AligningRecyclerView extends RecyclerView {
  ...
  public AligningRecyclerView(RecyclerView recyclerView) {
  ...
  private void init() {
    if(recyclerView!=null){
      recyclerView.addOnItemTouchListener(mOSLManager = new OnScrollListenerManagerOnItemTouchListener());
      recyclerView.addOnScrollListener(mOSL = new PositionTrackingOnScrollListener());
    }else {
