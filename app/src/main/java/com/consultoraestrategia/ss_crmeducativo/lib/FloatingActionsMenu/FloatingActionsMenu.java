package com.consultoraestrategia.ss_crmeducativo.lib.FloatingActionsMenu;
...
public class FloatingActionsMenu extends ViewGroup {
  public static final String TAG = "FloatingActionsMenu";
  ...
  public FloatingActionButton addButton(String title, @FloatingActionButton.FAB_SIZE int tamaño, @DrawableRes int icono){
    FloatingActionButton floatingActionButton = new FloatingActionButton(getContext());
    floatingActionButton.setTitle(title);
    floatingActionButton.setIcon(icono);
    floatingActionButton.setSize(tamaño);
