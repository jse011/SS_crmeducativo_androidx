...
public class GetTipoEvaluacionList extends UseCase<GetTipoEvaluacionList.RequestValues, GetTipoEvaluacionList.ResponseValue> {

    private static final String TAG = GetTipoEvaluacionList.class.getSimpleName();
    private CreateRubBidRepository repository;

    public GetTipoEvaluacionList(CreateRubBidRepository repository) {
    ...
    protected void executeUseCase(RequestValues requestValues) {
        ...
        repository.getTipoEvaluacionList(new CreateRubBidDataSource.Callback<TipoUi>() {
            @Override
