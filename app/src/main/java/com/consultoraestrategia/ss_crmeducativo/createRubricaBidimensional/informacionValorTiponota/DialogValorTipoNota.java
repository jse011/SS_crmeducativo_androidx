package com.consultoraestrategia.ss_crmeducativo.createRubricaBidimensional.informacionValorTiponota;
    ...
    public void showTipoNotaSelected() {
        ...
        if (getArguments() != null) {
            ...
            if (tipoNota != null) {
                ...
                String detalleTitulo = "Nivel logro: " + tipoNota.getTitle();
