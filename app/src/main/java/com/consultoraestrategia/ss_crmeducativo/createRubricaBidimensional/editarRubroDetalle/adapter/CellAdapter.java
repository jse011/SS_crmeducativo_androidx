...
import com.consultoraestrategia.ss_crmeducativo.createRubricaBidimensional.editarRubroDetalle.adapter.holder.CellHolder;
...
public class CellAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public CellAdapter(List<CriterioEvaluacionUi> criterioEvaluacionUis, RecyclerView recyclerView, InfoRubricaBidimensionalListener listener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        cellHolder.bind(listener,criterioEvaluacionUi);
