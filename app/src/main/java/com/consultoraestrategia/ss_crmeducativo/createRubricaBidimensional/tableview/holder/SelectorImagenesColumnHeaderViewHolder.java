...
public class SelectorImagenesColumnHeaderViewHolder extends AbstractSorterViewHolder {

    private static final String TAG = SelectorImagenesColumnHeaderViewHolder.class.getSimpleName();
    ...
    public SelectorImagenesColumnHeaderViewHolder(View itemView) {
        super(itemView);
