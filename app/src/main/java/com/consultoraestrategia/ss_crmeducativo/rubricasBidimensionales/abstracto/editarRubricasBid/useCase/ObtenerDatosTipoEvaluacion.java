...
public class ObtenerDatosTipoEvaluacion extends UseCase<ObtenerDatosTipoEvaluacion.RequestValues,ObtenerDatosTipoEvaluacion.ResponseValue>{
    ...
    public ObtenerDatosTipoEvaluacion(EditarRubricaRepository repository) {
    ...
    protected void executeUseCase(RequestValues requestValues) {
        repository.obtenerRegistroTipoEvaluacion(requestValues.getRubBidUi(), new EditarRubricaDataSource.CallBackRegistro<String, String>() {
            @Override
