package com.consultoraestrategia.ss_crmeducativo.evaluacionBidimencional.evalRubBidInd.repositorioComentario;
...
public class RepositorioArchivoViewImpl implements RepositorioView {
    ...
    private EvalRubBidIndPresenter evalRubBidIndPresenter;
    private RepositorioAdapter repositorioAdapter;
    private Fragment fragment;
    private final static int CUSTOM_REQUEST_CODE = 543;


    public RepositorioArchivoViewImpl(@NonNull Fragment fragment, EvalRubBidIndPresenter evalRubBidIndPresenter) {
        this.fragment = fragment;
        this.evalRubBidIndPresenter = evalRubBidIndPresenter;
    }
    ...
    public void saveArchivoComentario(RepositorioFileUi repositorioFileUi) {
        ...
        archivoComentarioUi.setArchivoId(IdGenerator.generateId());
        ...
        evalRubBidIndPresenter.saveComentarioArchivo(archivoComentarioUi);
    }
    ...
    public void removerArchivoComentario(RepositorioFileUi repositorioFileUi) {
        if(repositorioFileUi instanceof ArchivoComentarioUi){
            evalRubBidIndPresenter.removerComentarioArchivo((ArchivoComentarioUi)repositorioFileUi);
        } else {
            ArchivoComentarioUi archivoComentarioUi = new ArchivoComentarioUi();
            archivoComentarioUi.setArchivoId(repositorioFileUi.getArchivoId());
            evalRubBidIndPresenter.removerComentarioArchivo(archivoComentarioUi);
        }
    }
