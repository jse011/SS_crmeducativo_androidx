...
public class GetGrupoConProc extends UseCase<GetGrupoConProc.RequestValues, GetGrupoConProc.ResponseValue>{
    public static final String TAG = GetGrupoConProc.class.getSimpleName();
    private EvalRubBidRepository repository;

    public GetGrupoConProc(EvalRubBidRepository repository) {
    ...
    protected void executeUseCase(RequestValues requestValues) {
        ...
        try {
            repository.getGrupoConNotasProceso(requestValues, new EvalRubBidDataSource.GetAlumnConProcLisTCallback() {
                @Override
