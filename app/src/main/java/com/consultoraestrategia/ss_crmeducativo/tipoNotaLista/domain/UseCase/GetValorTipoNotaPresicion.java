...
public class GetValorTipoNotaPresicion  {


    public GetValorTipoNotaPresicion() {

    }


    public List<PrecisionUi> execute(GetValorTipoNotaPresicion.RequestValues requestValues) {
