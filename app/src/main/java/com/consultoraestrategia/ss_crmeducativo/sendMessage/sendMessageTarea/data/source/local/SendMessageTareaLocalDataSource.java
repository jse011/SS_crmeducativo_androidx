package com.consultoraestrategia.ss_crmeducativo.sendMessage.sendMessageTarea.data.source.local;
...
public class SendMessageTareaLocalDataSource implements SendMessageTareaDataSource {

    private static final String TAG = SendMessageTareaLocalDataSource.class.getSimpleName();
    private CompetenciaDao competenciaDao;

    public SendMessageTareaLocalDataSource() {
