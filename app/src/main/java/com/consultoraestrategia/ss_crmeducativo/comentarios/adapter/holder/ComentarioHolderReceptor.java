...
public class ComentarioHolderReceptor extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ComentarioHolderReceptor(View itemView) {
    ...
    fecha.setText(str);
        ...
        //Log.d(ComentariosLocalDataSource.class.getSimpleName(), "emisor"+ comentarioUi.toString());
    }
    @Override
