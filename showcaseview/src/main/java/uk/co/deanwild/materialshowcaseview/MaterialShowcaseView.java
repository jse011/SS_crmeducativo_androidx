...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
        ...
        if (mTarget != null) {
            ...
            if (!mRenderOverNav && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if(getLayoutParams() instanceof ConstraintLayout.LayoutParams){
                    ConstraintLayout.LayoutParams contentLP = (ConstraintLayout.LayoutParams) getLayoutParams();
            ...
            if (!mHasCustomGravity) {
                if (yPos > midPoint) {
                    ...
                    mContentTopMargin = 0;
                    mContentBottomMargin =  radius + mShapePadding;
    ...
    public static class Builder {
        ...
        public Builder(Fragment fragment) {
            ...
            showcaseView = new MaterialShowcaseView(fragment.getContext());
        }
        ...
        public Builder setDismissText(int resId) {
            ...
            return setDismissText(activity2!=null?activity2.getString(resId):fragment.getString(resId));
        }
        ...
        public Builder setSkipText(int resId) {
            return setSkipText(activity2!=null?activity2.getString(resId):fragment.getString(resId));
        }
        ...
        public Builder setContentText(int resId) {
            return setContentText(activity2!=null?activity2.getString(resId):fragment.getString(resId));
        }
        ...
        public Builder setTitleText(int resId) {
            return setTitleText(activity2!=null?activity2.getString(resId):fragment.getString(resId));
        }
    ...
    public boolean show(final Fragment fragment) {
