...
class FaceBoundsOverlay @JvmOverloads constructor(
    ...
    init {
        anchorPaint.color = ContextCompat.getColor(context, R.color.md_deep_orange_900)

        idPaint.color = ContextCompat.getColor(context, R.color.md_deep_orange_900)
        idPaint.textSize = 40f

        boundsPaint.style = Paint.Style.STROKE
        boundsPaint.color = ContextCompat.getColor(context, R.color.md_deep_orange_900)
    ...
    //añade los puntos de referencia
