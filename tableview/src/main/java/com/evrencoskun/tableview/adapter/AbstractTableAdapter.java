...
public abstract class AbstractTableAdapter<CH, RH, C> implements ITableAdapter {
    ...
    protected ColumnHeaderRecyclerViewAdapter mColumnHeaderRecyclerViewAdapter;
    protected RowHeaderRecyclerViewAdapter mRowHeaderRecyclerViewAdapter;
    protected CellRecyclerViewAdapter mCellRecyclerViewAdapter;
    ...
    @SuppressWarnings("unchecked")
    protected void dispatchCellDataSetChangesToListeners(List<List<C>> newCellItems) {
        if (dataSetChangedListeners != null) {
            for (AdapterDataSetChangedListener listener : dataSetChangedListeners) {
